...
def add_altmans_data(main_window_instance, widget_names, db_insert_method):
    ...
    widget_methods = {
        ...
        widget_names['altman_question']: (None, 'value', None),
        widget_names['altman_question_2']: (None, 'value', None),
        widget_names['altman_question_3']: (None, 'value', None),
        widget_names['altman_question_4']: (None, 'value', None),
        widget_names['altman_question_5']: (None, 'value', None),
...
def reset_altman_scribes(main_window_instance, widget_names):
    ...
    try:
        ...
        getattr(main_window_instance, widget_names['altman_question']).setValue(0)
        getattr(main_window_instance, widget_names['altman_question_2']).setValue(0)
        getattr(main_window_instance, widget_names['altman_question_3']).setValue(0)
        getattr(main_window_instance, widget_names['altman_question_4']).setValue(0)
        getattr(main_window_instance, widget_names['altman_question_5']).setValue(0)
